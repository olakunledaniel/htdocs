...
<div class="col-md-12">
    <div class="row">
        ...
        <table class="table table-bordered table-condensed text-right">
            ...
            <thead class="totals-table-header" id="header"><th>Total Items</th><th>Sub Total</th><th>Tax</th><th>Grand Total</th></thead>
        <tbody>
            <tr>
                <td><?=$item_count;?></td>
...
<!-- Modal -->
<div class="modal fade" data-backdrop="static" data-keyboard="false" id="checkoutModal" tabindex="-1" role="dialog" aria-labelledby="checkoutModalLabel">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <form action="thankYou.php" method="post" id="payment-form">
              ...
              <input type="hidden" name="description" value="<?=$item_count.' item'.(($item_count>1)?'s':'').' from Krisbee Stores.';?>">
...
<script>
    ...
    function check_address(){
      ...
      jQuery.ajax({
          url : '/krisbeestore/admin/parsers/check_address.php',
          method : 'POST',
          data : data,
