...
<style>
    body{
        background-image: url(/krisbeestore/img/cap.png);
...
<div id="login-form">
     ...
     <?php
         if ($_POST){
             ...
             if (!empty($errors)){
                 ...
                 $_SESSION['success_flash'] = 'Your password has been successfully changed.';
    ...
    <p class="text-right"><a href="/krisbeestore/index.php" alt="home">Visit Site</a></p>
</div>
