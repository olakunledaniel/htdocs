...
<?php
    ...
    if ($_POST) {
        ...
        if ($photoCount > 0) {
            ...
            $dbpath .= '/krisbeestore/img/products/'.$uploadName;
            if ($mimeType != 'image') {
            ...
            if ($fileSize > 1000000) {
                $errors[] = 'The file size must be under 1MB.';
            }
...
<!-- Modal -->
<div class="modal fade" id="sizesModal"  data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="sizesModalLabel" aria-hidden="true">
    ...
    ?>
      <tr>
          ...
          <td><a href="products.php?featured=<?=(($product['featured'] == 0)?'1':'0');?>&id=<?=$product['id'];?>" 
                 class="btn btn-xs  btn-default"><span class="glyphicon glyphicon-<?=(($product['featured']==1)?'minus':'plus');?>"></span>
